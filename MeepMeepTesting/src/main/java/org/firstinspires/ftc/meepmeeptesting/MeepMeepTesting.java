...
public class MeepMeepTesting {
    ...
    static void blue_goal_new(RoadRunnerBotEntity myBot){
    ...
    static void blue_goal(RoadRunnerBotEntity myBot){
    ...
    static void red_goal(RoadRunnerBotEntity myBot){
