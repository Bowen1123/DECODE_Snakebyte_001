...
public class B_Blue_Goal_Champ extends LinearOpMode {
    ...
    private double spikeX = -12 /*12*/ , spikeY = -64, spikeHeading = Math.toRadians(270);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TranslationalVelConstraint slow = new TranslationalVelConstraint(9);
