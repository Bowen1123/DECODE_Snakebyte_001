...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2584.709872861579; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -411.5433795583245; // x position of the perpendicular encoder (in tick units)
    }
