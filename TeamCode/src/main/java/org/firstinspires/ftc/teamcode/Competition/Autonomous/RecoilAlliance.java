...
@Autonomous
public class RecoilAlliance extends LinearOpMode {
    private double initX = 60, initY = 10, initHeading = Math.toRadians(-180);
    private double goalX = -13, goalY = 13, goalHeading = Math.toRadians(-225);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder end = drive.actionBuilder(goalPose)
                .setTangent(-180)
                .splineToLinearHeading(new Pose2d(-60, -20, Math.toRadians(-225)), Math.toRadians(180));
