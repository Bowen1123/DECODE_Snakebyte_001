...
@Autonomous
public class A_Red_Close extends LinearOpMode {
    ...
    private double spikeX = -12 /*12*/ , spikeY = 20, spikeHeading = -Math.toRadians(270);
    private double gateX = 0, gateY = 53, gateHeading =- Math.toRadians(180);
    private double intakeSpikeY = 68, parkingX = -60;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d intspike1Pose = new Pose2d( spikeX, intakeSpikeY, spikeHeading);
        Pose2d intspike2Pose = new Pose2d(spikeX + spike_x_gap, intakeSpikeY, spikeHeading);
        ...
        .splineToLinearHeading(intspike2Pose, intspike2Pose.heading.toDouble());
        ...
        TrajectoryActionBuilder back = (drive.actionBuilder( new Pose2d( spikeX, spikeY - 10, spikeHeading)))
                .splineToLinearHeading(new Pose2d( spikeX, spikeY - 10, spikeHeading), spikeHeading);
        ...
        TrajectoryActionBuilder intSpike1 = drive.actionBuilder(spike1Pose)
                .setTangent(getSpikeTangent)
                .splineToLinearHeading(intspike1Pose, spike1Pose.heading.toDouble() );

        TrajectoryActionBuilder toGoal1 = drive.actionBuilder(spike1Pose)
                .setTangent(toShootTangent)
