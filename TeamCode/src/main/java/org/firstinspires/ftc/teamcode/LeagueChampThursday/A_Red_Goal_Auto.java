...
@Autonomous
public class A_Red_Goal_Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d spike2Pose = new Pose2d( spikeX + spike_x_gap + 10, spikeY, spikeHeading);
        Pose2d spike1Pose = new Pose2d( spikeX + 5, spikeY, spikeHeading);
        Pose2d spike3Pose = new Pose2d( spikeX + (2* spike_x_gap) + 3, spikeY, spikeHeading);
