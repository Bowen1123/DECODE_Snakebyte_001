...
public class TestAuto1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder leave = drive.actionBuilder(new Pose2d(0, -24, Math.toRadians(90)))
                        .turn(Math.toRadians(135))
                        .lineToX(12);
                // .splineTo(new Vector2d(-24, 24), Math.toRadians(90));

        TrajectoryActionBuilder spike1 = drive.actionBuilder(new Pose2d(12, -24, Math.toRadians(90)))
